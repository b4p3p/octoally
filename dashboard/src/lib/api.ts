...
export const api = {
  ...
  projects: {
    ...
    update: (id: string, data: { name?: string; path?: string; description?: string; session_prompt?: string | null; openclaw_prompt?: string | null; default_web_url?: string | null; skip_permissions?: number; default_model?: string | null; color?: string }) =>
